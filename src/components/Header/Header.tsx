    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            renderPopover={
              <div className='flex w-52 flex-col px-3 py-2'>
                <button className='w-full px-3 py-2 hover:text-orange'>Tiếng Việt</button>
                <button className='mt-1 w-full px-3 py-2 hover:text-orange'>Tiếng Anh</button>
              </div>
            }
          ...
          {isAuthenticated && (
            ...
            >
              ...
              <div className=''>Dat Vo</div>
            </Popover>
          )}
          {!isAuthenticated && (
            <div className='flex items-center'>
              <Link to='/register' className='mx-3 capitalize hover:text-white/40'>
                Dang ky
              </Link>
              <div className='h-4 border-r-[1px]  border-r-white/40'></div>
              <Link to={path.login} className='mx-3 capitalize hover:text-white/40'>
                Dang nhap
              </Link>
            </div>
          )}
          <div className='flex cursor-pointer items-center py-1 hover:text-gray-300'></div>
        </div>
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                placeholder='Free ship cho đơn hàng từ 0đ...'
                {...register('name')}
              />
          ...
          <Popover
            ...
            renderPopover={
              <div
                className='bordr-gray-200 relative max-w-[400px] rounded-sm border bg-white 
                text-sm shadow-md
              '
              >
                <div className='p-2'>
